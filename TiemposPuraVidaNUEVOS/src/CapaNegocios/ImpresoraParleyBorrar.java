...
public class ImpresoraParleyBorrar implements Printable {
    private PapelParley papel;

    public ImpresoraParleyBorrar(PapelParley papel) {
        this.papel = papel;
    }
    ...
    throws PrinterException {   
        ...
        if (pageIndex == 0) {
            ...
            try{
                ...
                g2d.drawString("               BORRADO               ",10,y);y+=yShift;
                ...
                g2d.drawString("-------------------------------------",12,y);y+=yShift;
                g2d.drawString("        "+"Numero"+"   "+"Numero"+"   "+"Monto",10,y);y+=yShift;
                g2d.drawString("-------------------------------------",12,y);y+=yShift;
                int i = 0;
                while(i < papel.getNumeros().size()){
                    ...
                    montoTotal += (monto);
                    g2d.drawString("BORRADO   "+numero+"       "+numero2+"   *   "+monto,10,y);y+=yShift;
                    i+=1;
                }
                g2d.drawString("-------------------------------------",12,y);y+=yShift;
