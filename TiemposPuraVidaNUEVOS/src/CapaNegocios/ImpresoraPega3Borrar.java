 ...
 * @author francisco
 */
public class ImpresoraPega3Borrar implements Printable {
    private PapelPega3 papel;

    public ImpresoraPega3Borrar(PapelPega3 papel) {
        this.papel = papel;
    }
    ...
    throws PrinterException {   
        ...
        if (pageIndex == 0) {
            ...
            try{
                ...
                g2d.drawString("            PEGA 3 BORRADO             ",10,y);y+=yShift;
                ...
                while(i < papel.getNumeros().size()){
                    ...
                    montoTotal += (monto);
                    g2d.drawString("  BORRA     "+numero+"     "+modalidad+"   "+monto,10,y);y+=yShift;
                    i+=1;
                }
                g2d.drawString("-------------------------------------",12,y);y+=yShift;
